        ...
        <main>
            <div className={jsbodyStyles.piece}>
                ...
                <div className={jsbodyStyles.paragraph}>
                    <p><span className={jsbodyStyles.jsyel}>JavaScript</span> is one of the most popular and widely used programming languages in the world. It is one of the core technologies of the <a className={jsbodyStyles.noStyle} href="https://webfoundation.org/about/" target="_blank"  rel="noopener noreferrer"><span className={jsbodyStyles.w1}>World</span><span className={jsbodyStyles.w2}> Wide</span> <span className={jsbodyStyles.w3}>Web</span></a> - every major web browser has a JS engine. <br /><br />Though it was originally made to be used in browsers for developers to add interactivity to <a className={jsbodyStyles.noStyle} href="https://developer.mozilla.org/en-US/docs/Learn/Common_questions/Pages_sites_servers_and_search_engines" target="_blank"  rel="noopener noreferrer"><span className={jsbodyStyles.webpage}>web pages</span></a>, it can now also be used to build mobile apps, games, real-time networking apps and command line tools. In 2009 Ryan Dahl wrote <a className={jsbodyStyles.noStyle} href="https://nodejs.org/en/docs/" target="_blank"  rel="noopener noreferrer"><span className={jsbodyStyles.node1}>Node JS</span></a>, which is a <span class="balloon" data-balloon="What does this even mean?" data-balloon-pos="up">'run-time environment'</span> that allows
                        developers to use JavaScript for server-side scripting. Microsoft, <a className={jsbodyStyles.noStyle} href="https://www.paypal.com" target="_blank"  rel="noopener noreferrer"><span className={jsbodyStyles.paypal}>Paypal</span></a>,
                        <a className={jsbodyStyles.noStyle} href="https://www.netflix.com" target="_blank"  rel="noopener noreferrer"><span className={jsbodyStyles.neto} data-balloon="Distractions hahahaha" data-balloon-pos="up"> Netflix, </span></a> <a className={jsbodyStyles.noStyle} href="https://www.uber.com" target="_blank"  rel="noopener noreferrer">Uber</a> and
                        <a  className={jsbodyStyles.noStyle}href="https://www.linkedin.com/" target="_blank"  rel="noopener noreferrer"><span className={jsbodyStyles.linkedin}> Linkedin</span></a> are just a few of the major companies that use <span class="balloon" data-balloon="Not the same thing as Java." data-balloon-pos="down">JavaScript</span> for their websites.</p>
