        ...
        <main>
            <div className={jsbodyStyles.piece}>
                ...
                <div className={jsbodyStyles.paragraph}>
                    <p><span className={jsbodyStyles.jsyel}>JavaScript</span> is one of the most popular and widely used programming languages in the world. It is one of the core technologies of the <a className={jsbodyStyles.noStyle} href="https://webfoundation.org/about/" target="_blank"><span className={jsbodyStyles.w1}>World</span><span className={jsbodyStyles.w2}> Wide</span> <span className={jsbodyStyles.w3}>Web</span></a> - every major web browser has a JS engine. <br /><br />Though it was originally made to be used in browsers for developers to add interactivity to <a className={jsbodyStyles.noStyle} href="https://developer.mozilla.org/en-US/docs/Learn/Common_questions/Pages_sites_servers_and_search_engines"><span className={jsbodyStyles.webpage}>web pages</span></a>, it can now also be used to build mobile apps, games, real-time networking apps and command line tools. In 2009 Ryan Dahl wrote <a className={jsbodyStyles.noStyle} href="https://nodejs.org/en/docs/" target="_blank"><span className={jsbodyStyles.node1}>Node JS</span></a>, which is a <span class="balloon" data-balloon="What does this even mean?" data-balloon-pos="up">'run-time environment'</span> that allows
